      ...
      <div id="app-sidepanel" class="app-sidepanel">
        ...
        <div class="sidepanel-inner d-flex flex-column">
          ...
          <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
              <li class="nav-item">
                ...
                <!--//nav-link-->
                        ...
                        <li class="nav-item">
                <router-link class="nav-link" :to="{name: 'Estudiante'}" exact-active-class="active">
                  <span class="nav-icon">
            ...
            <!--//nav-item-->
              <li class="nav-item">
                <router-link class="nav-link" :to="{name: 'Cursos'}" exact-active-class="active">
                  <span class="nav-icon">
              ...
              <ul class="app-menu footer-menu list-unstyled">
                <li class="nav-item">
                  <a class="nav-link" href="#">
                    <span class="nav-icon">
                      <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="bi bi-box-arrow-left" viewBox="0 0 16 16">
    ...
    <div class="app-wrapper">
      ...
      <footer class="app-footer">
        <div class="container text-center py-3">
          <small class="copyright">Designed by
            <a class="app-link" href="#" target="_blank">Oscar</a></small>
        </div>
      </footer>
      <!--//app-footer-->
    </div>
